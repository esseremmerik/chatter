                        ...
                        <ul class="discussions no-bg" style="display:block;">
                            @foreach($posts as $post)
		                		...
		                		<span class="chatter_posts">
									...
									@can('remove-others-forum-comments')
					        			...
					        			@if(Config::get('chatter.user.avatar_image_database_field'))
                                            ...
                                            @else
                                                <span class="chatter_avatar_circle"
                                                      style="background-color:#<?= Chatter::stringToColorCode($post->user->email) ?>">
					        		...
					        		<div class="chatter_middle">
					        			<span class="chatter_middle_details"><a
                                                    href="{{ Chatter::getUserLink($post->user) }}">{{ ucfirst($post->user->{Config::get('chatter.user.database_field_with_user_name')}) }}</a> <span
                    ...
                    @if(!Auth::guest())
                        ...
                        <div id="new_response">
                            ...
                            @if(Config::get('chatter.user.avatar_image_database_field'))
                                ...
                                @else
                                    <span class="chatter_avatar_circle"
                                          style="background-color:#<?= Chatter::stringToColorCode(Auth::user()->email) ?>">
                            ...
                            <button id="submit_response" class="btn btn-success pull-right"><i class="chatter-new"></i>
                                Submit Response
                            </button>
                        </div>
                    ...
                    @else
                        ...
                        <div id="login_or_register">
                            <p>Please <a href="/{{ Config::get('chatter.routes.home') }}/login">login</a> or <a
                                        href="/{{ Config::get('chatter.routes.home') }}/register">register</a> to leave
                                a response.</p>
                        </div>
